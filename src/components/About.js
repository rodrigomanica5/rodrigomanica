      ...
      <div className='aboutMe' ref={about}>
        <div className='detailContainer'>
          ...
          <div className='aboutInfo'>
            <p className='aboutInfoSpan'>My name is Rodrigo and I'm a React.js Frontend Developer.</p>
          ...
          <a className='btn' href='https://drive.google.com/file/d/1RLGbbMTLw94sveqZhqj8aevARKU5QLjE/view' target="_blank" rel="noreferrer">MY RESUME</a>
        </div>
